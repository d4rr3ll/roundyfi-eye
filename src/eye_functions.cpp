...
#include <Arduino.h>
#include "config.h" // Ensure eyeBlink is accessible

extern eyeInfo_t eyeInfo[]; // Declare eyeInfo as extern

#include <TFT_eSPI.h> // Include TFT_eSPI library

extern TFT_eSPI tft; // Declare tft as extern to use it here
extern uint16_t pbuffer[BUFFERS][BUFFER_SIZE]; // Declare pbuffer as extern
extern bool dmaBuf; // Declare dmaBuf as extern

extern uint32_t startTime; // Declare startTime as extern
extern void user_loop(void); // Declare user_loop as extern
...
void frame(uint16_t iScale) // Iris scale (0-1023)
{
  ...
  static uint8_t uThreshold = SCREEN_WIDTH;
